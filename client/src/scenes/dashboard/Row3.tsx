    ...
    <>
      ...
      <DashboardBox bgcolor="#fff" gridArea="j">
        ...
        <Typography margin="0 1rem" variant="h6">
          ...
          atque maxime recusandae consequuntur exercitationem alias suscipit
          facilis qui necessitatibus quo, temporibus praesentium vel asperiores
          debitis sequi voluptatem!
        </Typography>
      </DashboardBox>
    </>
  );
